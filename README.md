...
<div>
  <h3>프로젝트 기간📆</h3>
  <p>2022년 11월 7일 ~ 2022년 12월 18일</p>
</div>
<br>

<div>
  <h3>프로젝트 목표📈</h3>
  <p>JSP 프로젝트에서 구현하지 못한 기능들 모두 구현하기<br>
  결제API, OAuth 도입하기<br>
  기획 구체화하여 꼼꼼하게 진행하기<br>
  맡은 기능 100% 구현하기<br>
  문제 발생 시 꼭!! 커뮤니케이션 하기
  </p>
</div>
...
<div>
  <h3>프로젝트에서 맡은 역할</h3>
  <p>퍼블리싱 : 메인페이지, 아르바이트<br>
  백엔드 : 웹소켓을 활용한 실시간 채팅 기능 구현, 채팅 알림 구현, OAuth(구글) 구현</p>
</div>
<br>
